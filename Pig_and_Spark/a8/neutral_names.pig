...
male_names_counts = FOREACH male_names_groups GENERATE group as m_name, SUM(male_names.number) as m_count;
...
female_names_counts = FOREACH female_names_groups GENERATE group as f_name, SUM(female_names.number) as f_count;
